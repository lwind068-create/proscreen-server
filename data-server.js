...
app.get('/api/news/:ticker', async (req, res) => {
  ...
  try {
    ...
    const positiveWords = ['surge','soar','gain','rise','beat','record','growth','profit','strong','buy','upgrade','bullish','boost','rally','jump'];
    const negativeWords = ['fall','drop','decline','miss','lose','weak','sell','downgrade','bearish','crash','plunge','concern','risk','cut','warn','probe','fine','lawsuit'];
